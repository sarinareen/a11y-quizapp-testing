...
/* User story:
This quiz app allows users to take a quiz on a topic about bass. 
      ...
      <form class="quizForm">
        <fieldset>
          ...
          <div class="radiogroup">
            <input class="inputSize" type="radio" name="option" id="musician" value="${answers[0]}" checked>
            <label for="musician">${answers[0]}</label>
            <br>
          </div>
          <div class="radiogroup">
            <input type="radio" name="option" id="musician2" value="${answers[1]}">
            <label for="musician2">${answers[1]}</label>
            <br>
          </div>
          <div class="radiogroup">
            <input type="radio" name="option" id="musician3" value="${answers[2]}">
            <label for="musician3">${answers[2]}</label>
            <br>
          </div>
          <div class="radiogroup">
            <input type="radio" name="option" id="musician4" value="${answers[3]}">
            <label for="musician4">${answers[3]}</label>
          </div>
        </fieldset>
